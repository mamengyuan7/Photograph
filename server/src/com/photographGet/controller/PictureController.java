...
public class PictureController {
	...
	public String listpart(@RequestParam("userId") String userId,Model model,HttpServletRequest req,HttpServletResponse rep) {
		rep.setCharacterEncoding("UTF-8");
		rep.setContentType("text/html;charset=UTF-8");
		Gson gson=new Gson();
	...
	public String typepic(@RequestParam("typeId") String typeId,Model model,HttpServletRequest req,HttpServletResponse rep) {
		rep.setCharacterEncoding("UTF-8");
		rep.setContentType("text/html;charset=UTF-8");
		Gson gson=new Gson();
		System.out.println(typeId);
		int tId = Integer.parseInt(typeId);
		List<Picture> pics = pictureService.findByTypeId(tId);
		String picsing=gson.toJson(pics);
		model.addAttribute("pics",picsing);
		System.out.println(picsing);
		PrintWriter writer;

...
public class UploadHelper {
    ...
    //上传仓库名
    private static final String BUCKET_NAME = "savepicturetab";

    private static OSS getOSSClient() {
        ObjectMetadata objectMetadata = new ObjectMetadata();
        objectMetadata.setContentType("image/jpg");
        OSSCredentialProvider credentialProvider =
                new OSSPlainTextAKSKCredentialProvider("LTAI5tSCmqvjgA93rGsxr6oZ"
                        , "LF4Pn3Sfkblf5BBkFEh5msc1novtIl");
        return new OSSClient( App.getContext(), ENDPOINT, credentialProvider);
    }
